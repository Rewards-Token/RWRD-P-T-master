...
Unknown macro: { if (a == 0) { return 0; } uint256 c = a * b; assert(c / a == b); return c; }
...
*/
function HasNoEther() public payable { require(msg.value == 0); }
/**
...
*/
function reclaimEther() external onlyOwner { assert(owner.send(this.balance)); }
}
...
contract RWRDPToken is MintableToken, NoOwner, Destructible { //MintableToken is StandardToken, Ownable
string public symbol = 'RWRDP';
string public name = 'Rewards Promo Token';
...
*/
modifier canTransfer() { require(transfersEnabled); _; }
/**

@notice Use for disable transfers before exchange to main RWRD tokens
*/
function setTransfersEnabled(bool enable) onlyOwner public { transfersEnabled = enable; }
function transfer(address _to, uint256 _value) canTransfer public returns (bool)

{ notifyICO(msg.sender, _to, _value); return super.transfer(_to, _value); }
function transferFrom(address _from, address _to, uint256 _value) canTransfer public returns (bool)

{ notifyICO(_from, _to, _value); return super.transferFrom(_from, _to, _value); }
